...
#define SET_RWX(addr, size) if (addr) sl_mprotect(addr, size, PROT_READ|PROT_WRITE|PROT_EXEC)
#define SET_RX(addr, size) if (addr) sl_mprotect(addr, size, PROT_READ|PROT_EXEC)
#define SET_RW(addr, size) if (addr) sl_mprotect(addr, size, PROT_READ|PROT_WRITE)
#define SET_PROT(addr, size, prot) if (addr) sl_mprotect(addr, size, prot)
...
#define REG_ARGS_STDCALL(num) __attribute__ ((regparm (num), stdcall))
