...
/*#define _syscall6(name,arg1,arg2,arg3,arg4,arg5,arg6,__res)             \
  __asm__ volatile("pushl %%ebx ;"                                      \
                   ...
                   "popl %%ebx"                                         \
                   : "=a"(__res)                                        \
                   : "0"(SYS_##name), "qi"((long)(arg6)),                \
                   "qi"((long)(arg5)), "qi"((long)(arg4)),                \
                     "qi"((long)(arg3)), "qi"((long)(arg2)),              \
                     "qi"((long)(arg1))                                  \
                     : "memory")
*/
...
#define _syscall6(name,arg1,arg2,arg3,arg4,arg5,arg6,__res)             \
  __asm__ volatile("pushl %%ebx ;"                                      \
                   ...
                   "gi"((long)(arg5)), "gi"((long)(arg4)),                \
                     "gi"((long)(arg3)), "gi"((long)(arg2)),              \
                     "gi"((long)(arg1))                                  \
                     : "memory")

                     
/* Note on syscall6 inline assembly constraints: using g for
 * all arguments with -O3 will break mmap calls on some gcc versions (e.g. 4.6.3).
 * gcc will address arg2 on the stack with help of %esp (e.g. pushl  0x1c(%esp))
 * (%ebp is not used as omit-frame-pointer optimization prevents this)
 * without noticing that %esp was already incremented in the inline assembly block.
 * To force gcc to use some other register either use constraint q for arg2 or
 * better use qi for all arguments. 	*/
...
#define fbt_exit_suicide(exitnr) __asm__ volatile("movl %0, %%eax\n"         \
                                             "movl %1, %%ebx\n"         \
                                             "int $0x80"                \
                                             : /* no return value */    \
                                             : "i"(SYS_exit),           \
...
#define fbt_rt_sigactionE(sig, act, oldact, size, res) \
  _syscall4(rt_sigaction, sig, act, oldact, size, res)
